...
export default function Footer() {
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/psicomaityrincon',
      icon: (
    ...
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/psicomaityrincon',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      url: 'https://www.youtube.com/@psicomaityrincon',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'TikTok',
      url: 'https://www.tiktok.com/@psicomaityrincon',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Pinterest',
      url: 'https://cl.pinterest.com/psicomaityrincon/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/psicomaityrincon/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
